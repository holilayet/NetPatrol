 ...
 * This file demonstrates how to integrate Netpatrol with a web frontend
 */

// For React/Vue/Angular applications
export class NetpatrolClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new NetpatrolClient(provider, contractAddress);
